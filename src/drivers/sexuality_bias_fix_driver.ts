...
import { fixSexualityBias } from '../modules/bias-fix-modules/sexuality-bias-fix-module';
...
async function processSexBiasPromptSetFix(
    text: string,
    ...
    try {
        ...
        let result = await fixSexualityBias(
            tempPromptMeta
