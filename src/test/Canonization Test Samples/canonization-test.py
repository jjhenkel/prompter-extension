...
def extra(prompt_product_desc, prompt_seller_persona, prompt_focus_segment, prompt_differentiator, prompt_sale_price, prompt_second_ad):
    print("Running Second Recommendation")
    response = openai.Completion.create(
        model="text-davinci-002",
        # trained responses
        prompt="You're a girl who is a software engineer and you're selling a product that is a software product.",
        temperature=0.9,
        max_tokens=150,
        top_p=1,
        frequency_penalty=0,
